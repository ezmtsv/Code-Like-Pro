...
class PostDaoImpl(private val db: SQLiteDatabase) : PostDao {
    companion object {
        ...
        CREATE TABLE ${PostColumns.TABLE} (
            ...
            ${PostColumns.COLUMN_VIDEO} TEXT NOT NULL DEFAULT video
        );
        """.trimIndent()
    }
//            ${PostColumns.COLUMN_VIDEO} TEXT NOT NULL
    object PostColumns {
        ...
        const val COLUMN_REPOST = "countRepost"
        const val COLUMN_VIEWS = "countViews"
        const val COLUMN_VIDEO = "linkVideo"
    ...
    override fun save(post: Post): Post {
        ...
        val id = if (post.id != 0) {
            ...
            values.put(PostColumns.COLUMN_AUTHOR, post.author)
            values.put(PostColumns.COLUMN_PUBLISHED, post.published)
    ...
    private fun map(cursor: Cursor): Post {
        with(cursor) {
            return Post(
                ...
                countRepost = getInt(getColumnIndexOrThrow(PostColumns.COLUMN_REPOST)),
